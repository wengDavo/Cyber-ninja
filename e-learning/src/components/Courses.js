  ...
  return (
    <section className="grid gap-y-4 border border-white-99 p-3 md:p-10">
      {courses.map((course) => (
        ...
        >
          <div>
            <h3 className="course--title text-2xl font-semiBold leading-6">{course.title}</h3>
      ...
      <article className="grid gap-y-4 border py-2 border-white-95 bg-white-97 rounded-regular p-3 md:p-10">
        <div>
        ...
        <div>
          <figure className="course--images flex justify-between gap-x-2">
            <img src={manClipboard} alt="" className="w-[32%] object-cover" />
            <img src={manWriting} alt="" className="w-[32%] object-cover" />
            <img src={womanDesktop} alt="" className="w-[32%] " />
          </figure>
          <div className="course--info md:flex md:gap-x-4">
            <span className=" rounded-regular mt-3 text-grey-35 h-fit inline-block border border-white-95 p-1">
              4 weeks
            </span>
            <span className=" rounded-regular mt-3 text-grey-35 h-fit inline-block border border-white-95 p-1">
        ...
        <div className="curriculum flex flex-col gap-y-5 py-4 px-5 border border-white-95 rounded-regular">
          ...
          <div className="topics md:flex md:justify-between divide-y md:divide-x md:divide-y-0 divide-white-90">
            <div className="topic md:px-3">
              <p className="topic--number font-extraBold text-3xl">01</p>
              <p className="topic--name font-medium text-grey-20 leading-6 text-sm md:w-[80%]">
                Intoroduction to HTML
              </p>
            </div>
            <div className="topic md:px-3">
              <p className="topic--number font-extraBold text-3xl">02</p>
              <p className="topic--name font-medium text-grey-20 leading-6 text-sm md:w-[80%]">
                Intoroduction to HTML
              </p>
            </div>
            <div className="topic md:px-3">
              <p className="topic--number font-extraBold text-3xl">03</p>
              <p className="topic--name font-medium text-grey-20 leading-6 text-sm md:w-[80%]">
                Intoroduction to HTML
              </p>
            </div>
            <div className="topic md:px-3">
              <p className="topic--number font-extraBold text-3xl">04</p>
              <p className="topic--name font-medium text-grey-20 leading-6 text-sm md:w-[80%]">
                Intoroduction to HTML
              </p>
            </div>
            <div className="topic md:px-3">
              <p className="topic--number font-extraBold text-3xl">05</p>
              <p className="topic--name font-medium text-grey-20 leading-6 text-sm md:w-[80%]">
                Intoroduction to HTML
              </p>
            </div>
