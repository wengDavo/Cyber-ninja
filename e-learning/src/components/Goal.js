    ...
    <section className="grid gap-8 bg-white-97 rounded-regular p-3">
      ...
      <article className="grid gap-4 md:grid-cols-2">
        <div className="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={notes} alt="" className="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
        ...
        <div className="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={bookClosed} alt="" className="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
        ...
        <div className="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={weights} alt="" className="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
          <p className="text-lg font-medium">Promote Collaboration and Community</p>
          <p className="bg-white-97 rounded-regular  md:flex md:items-center md:justify-between">
        ...
        <div className="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={alert} alt="" className="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
