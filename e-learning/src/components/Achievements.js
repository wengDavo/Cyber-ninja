  ...
  return (
    <section class="grid gap-8 bg-white-97 rounded-regular p-3">
      ...
      <article class="grid gap-4 md:grid-cols-2">
        <div class="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img
              src={crown}
              alt=""
              class="border border-orange-90 bg-orange-97 p-3 rounded-regular"
            />
          </figure>
          <p class="text-lg font-medium">Trusted by Thousands</p>
        ...
        <div class="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={medal} alt="" class="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
          <p class="text-lg font-medium">Award-Winning Courses</p>
          <p class="bg-white-97 rounded-regular  md:flex md:items-center md:justify-between">
        ...
        <div class="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={twoMasks} alt="" class="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
          <p class="text-lg font-medium">Positive Student Feedback</p>
          <p class="bg-white-97 rounded-regular  md:flex md:items-center md:justify-between">
        ...
        <div class="border border-white-95 p-8 grid rounded-regular">
          <figure>
            <img src={boltShield} alt="" class="border border-orange-90 bg-orange-97 p-3 rounded-regular" />
          </figure>
          <p class="text-lg font-medium">Industry Partnerships</p>
          <p class="bg-white-97 rounded-regular  md:flex md:items-center md:justify-between">
